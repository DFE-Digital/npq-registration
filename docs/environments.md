...
| Sandbox | https://sandbox.register-npq.education.gov.uk | External users (e.g. lead providers) | Explore the service without affecting production data | Merge to `main` | production | [View](https://sandbox.register-npq.education.gov.uk/healthcheck.json) |
| Staging | https://staging.register-npq.education.gov.uk | Team members | Production-like environment without real data | Merge to `main` | test | [View](https://staging.register-npq.education.gov.uk/healthcheck.json)|
