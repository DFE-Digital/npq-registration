...
RSpec.describe Questionnaires::ChooseYourProvider, type: :model do
  ...
  describe "#previous_step" do
    ...
    context "when the course is EHCO" do
      ...
      context "when the user has chosen to proceed without funding" do
    ...
    context "when the work setting is 'other'" do
      ...
      context "when not referred by a Return To Teaching Adviser (RTTA)" do
        before { store["referred_by_return_to_teaching_adviser"] = "no" }
