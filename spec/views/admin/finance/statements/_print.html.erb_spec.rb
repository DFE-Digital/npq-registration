...
RSpec.describe "admin/finance/statements/_print", type: :view do
  ...
  describe "cohort display" do
    context "when rendering for provider (internal_dfe_use: false)" do
      subject { render partial: "admin/finance/statements/print", locals: { internal_dfe_use: false } }
    ...
    context "when rendering for DfE (internal_dfe_use: true)" do
      subject { render partial: "admin/finance/statements/print", locals: { internal_dfe_use: true } }
