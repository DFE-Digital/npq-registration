...
RSpec.describe "admin/applications/revert_to_pending/new", type: :view do
  subject { render }
  ...
  it { is_expected.to have_field("applications-revert-to-pending-change-status-to-pending-yes-field") }
