...
RSpec.describe Statements::DeclarationsCalculator do
  ...
  # declarations
  let(:started_declaration) { create(:declaration, :eligible, declaration_type: "started", application: application_with_eligible_declaration, course:, lead_provider:, cohort:, statement:) }
