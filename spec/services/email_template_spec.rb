...
RSpec.describe EmailTemplate do
  ...
  context "when eligible for scholarship funding" do
    it "returns eligible_scholarship_funding without tsf" do
  ...
  context "when not eligible for scholarship (already funded) and no for TSF" do
  ...
  context "when not eligible for scholarship and no for TSF" do
