...
RSpec.describe Services::Admin::DashboardStats do
  ...
  let(:applications_created_before_start_time) {
  ...
  context "with a start_time" do
    subject { described_class.new(start_time: start_time) }
