...
RSpec.describe Middleware::ApiRequestMiddleware, type: :request do
  ...
  context "when running in allowed environments" do
    ...
    describe "#call with various content types" do
      ...
      it "fires StreamAPIRequestsToBigQueryJob for text/json" do
        request.post "/api/v3/participant-declarations",
      ...
      it "fires StreamAPIRequestsToBigQueryJob for application/vnd.api+json" do
        request.post "/api/v3/participant-declarations",
      ...
      it "fires StreamAPIRequestsToBigQueryJob when content type is missing" do
        request.post "/api/v3/participant-declarations", input: '{"foo":"bar"}'
