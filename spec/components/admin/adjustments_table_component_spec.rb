...
RSpec.describe Admin::AdjustmentsTableComponent, type: :component do
  ...
  describe "table of adjustments" do
    ...
    context "when show_actions is true" do
      ...
      it { is_expected.to have_link t(".edit"), href: urls.edit_admin_finance_statement_adjustment_path(statement, adjustment_1, show_all_adjustments: false) }
      it { is_expected.to have_link t(".edit"), href: urls.edit_admin_finance_statement_adjustment_path(statement, adjustment_2, show_all_adjustments: false) }
      it { is_expected.to have_link t(".edit"), href: urls.edit_admin_finance_statement_adjustment_path(statement, adjustment_3, show_all_adjustments: false) }

      it { is_expected.to have_link t(".remove"), href: urls.delete_admin_finance_statement_adjustment_path(statement, adjustment_1, show_all_adjustments: false) }
      it { is_expected.to have_link t(".remove"), href: urls.delete_admin_finance_statement_adjustment_path(statement, adjustment_2, show_all_adjustments: false) }
      it { is_expected.to have_link t(".remove"), href: urls.delete_admin_finance_statement_adjustment_path(statement, adjustment_3, show_all_adjustments: false) }
    end
  end
