...
RSpec.describe NavigationStructures::GuidanceNavigationStructure, type: :component do
  describe "#primary_structure" do
    subject { NavigationStructures::GuidanceNavigationStructure.new.primary_structure }
