...
RSpec.feature "Updating eligibility lists", :no_js, type: :feature do
  ...
  scenario "Updating PP50 Schools eligibility list" do
    ...
    expect(already_eligible_school_pp50.pp50?(Questionnaires::WorkSetting::A_SCHOOL)).to be false
  end
  ...
  scenario "Updating PP50 FE eligibility list" do
    ...
    expect(already_eligible_fe_pp50.pp50?(Questionnaires::WorkSetting::A_16_TO_19_EDUCATIONAL_SETTING)).to be false
  end
  ...
  scenario "Updating Childminders eligibility list" do
    ...
    expect(already_eligible_childminder.on_childminders_list?).to be false
  end
  ...
  scenario "Updating Disadvantaged Early Years Schools eligibility list" do
    ...
    expect(already_eligible_ey_childcare_provider.eyl_disadvantaged?).to be false
    expect(already_eligible_ey_school.eyl_disadvantaged?).to be false
  end
  ...
  scenario "Updating Local Authority Disadvantaged Nurseries eligibility list" do
    ...
    expect(already_eligible_la_nursery.la_disadvantaged_nursery?).to be false
  end
