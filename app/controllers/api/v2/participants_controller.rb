  ...
  module V2
    class ParticipantsController < BaseController
      def index
        ...
        render 'api/v2/participants/index', status: :ok
      end

      def show
        Participants::ShowService.find

        render 'api/v2/participants/show', status: :ok
      end
      ...
      def resume
        ...
        render 'api/v2/participants/resume', status: :ok
      end

      def withdraw
        Participants::WithdrawService.withdraw(@participant)

        render 'api/v2/participants/withdraw', status: :ok
      end
