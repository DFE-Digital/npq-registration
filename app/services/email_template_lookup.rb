class EmailTemplateLookup
  def self.call(key)
    {
      # "Default"
      default: "b0eaf5fb-b94b-4846-ac44-105f4a7b1462",
      ...
      not_england_wrong_catchment: "be84eb1e-eb8a-4238-9902-d2f9e03ab453",
    ...
    }.fetch(key, "b0eaf5fb-b94b-4846-ac44-105f4a7b1462")
  end
end
