module DeliveryPartners
  class Query
    ...
    def initialize(lead_provider: :ignore, cohort_start_year: :ignore, sort: nil)
  ...
  private
    ...
    def order_by
      sort_order(sort:, model: DeliveryPartner, default: { created_at: :asc })
    end

    def all_delivery_partners
      DeliveryPartner.joins(delivery_partnerships: %i[cohort lead_provider])
    end
  end
end
