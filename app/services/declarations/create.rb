...
module Declarations
  class Create
    ...
    def application
      ...
      course = Course.find_by(identifier: course_identifier)&.rebranded_alternative_courses
      ...
      if application_id.present?
        scope = scope.where(ecf_id: application_id)
      end

      @application ||= scope.find_by(lead_provider:, course: course)
    end
