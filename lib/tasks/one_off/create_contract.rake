  ...
  def initialize
    namespace :one_off do
      ...
      task :create_contract, %i[file dry_run] => :environment do |_t, args|
        ...
        statement = Statement.find_by(year: STATEMENT_YEAR, month: STATEMENT_MONTH, cohort: Cohort.find_by(identifier: COHORT_NAME), lead_provider: LeadProvider.find_by(name: LEAD_PROVIDER_NAME))
