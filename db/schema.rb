...
ActiveRecord::Schema[8.1].define(version: 2026_05_05_115737) do
  ...
  create_enum "cohort_funding", ["zero", "capped", "full"]
  ...
  create_table "cohorts", force: :cascade do |t|
    ...
    t.uuid "ecf_id"
    t.enum "funding", default: "full", null: false, enum_type: "cohort_funding"
  ...
  create_table "oauth_tokens", force: :cascade do |t|
    ...
    t.enum "token_type", default: "refresh_token", null: false, enum_type: "oauth_token_types"
    t.datetime "token_updated_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["token_updated_at"], name: "index_oauth_tokens_on_token_updated_at"
    t.index ["user_id", "token_type"], name: "index_oauth_tokens_on_user_id_and_token_type", unique: true
